...
train_pipeline = [
    ...
    dict(
        type='LoadAnnotationsBEVDepth4DTraj',
    ...
    dict(
        type='Collect4D', keys=['img_inputs', 'gt_depth', 'voxel_semantics',
                                'mask_lidar','mask_camera',
                                'gt_depths', 'rays', 'temporal_semantics', 'temporal_rays', 'temporal_ego_states', 'temporal_trajs'
                               ])
]
    ...
    dict(
        ...
        transforms=[
            dict(
                ...
                with_label=False),
            dict(type='Collect4D', keys=['points', 'img_inputs', 'voxel_semantics',
                                        'mask_lidar','mask_camera',
                                        'gt_depths', 'rays',
