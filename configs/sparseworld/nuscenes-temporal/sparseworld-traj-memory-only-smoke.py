_base_ = ['./sparseworld-traj-memory-only.py']

# Short user-run connectivity gate. This intentionally uses an iteration-based
# runner so it cannot be confused with the formal 12-epoch experiment.
...
optimizer_config = dict(
    _delete_=True,
    type='QueryMemoryConnectivityOptimizerHook',
