...
class NuScenesDataset(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        # if info['token'].startswith('4dfab'):
        #     print('stop here!')

        viewpad = np.eye(4)
        viewpad[:3,:3] = pyquaternion.Quaternion(info['ego2global_rotation']).rotation_matrix
        viewpad[:3,3] = np.array(info['ego2global_translation'])
