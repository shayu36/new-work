...
def parse_args():
    ...
    parser.add_argument('--config', default='./configs/preworld/nuscenes-temporal/sparseworld-7frame-finetune.py',help='test config file path')
    parser.add_argument('--checkpoint',default='./work_dirs/sparseworld_7frame_pretrain/epoch_48.pth', help='checkpoint file')
